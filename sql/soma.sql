...
-- Table `soma`.`Endereco`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Endereco` ;
...
CREATE UNIQUE INDEX `descCidade_UNIQUE` ON `soma`.`Endereco` (`descCidade` ASC) VISIBLE;

CREATE UNIQUE INDEX `siglaUf_UNIQUE` ON `soma`.`Endereco` (`siglaUf` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Usuario` ;
...
CREATE INDEX `fk_Usuario_Endereco_idx` ON `soma`.`Usuario` (`Endereco_idEndereco` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Vendedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Vendedor` ;
...
CREATE INDEX `fk_Cliente_Usuario1_idx` ON `soma`.`Vendedor` (`Usuario_idUsuario` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Cliente`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Cliente` ;

CREATE TABLE IF NOT EXISTS `soma`.`Cliente` (
  `idCliente` INT NOT NULL AUTO_INCREMENT,
  `dataCadastro` DATE NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX `fk_Cliente_Usuario1_idx` ON `soma`.`Cliente` (`Usuario_idUsuario` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Produto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Produto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`ProdutoVendedor` ;
...
CREATE INDEX `fk_Produto_has_Vendedor_Vendedor1_idx` ON `soma`.`ProdutoVendedor` (`Vendedor_idVendedor` ASC) VISIBLE;

CREATE INDEX `fk_Produto_has_Vendedor_Produto1_idx` ON `soma`.`ProdutoVendedor` (`Produto_idProduto` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Servico`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Servico` ;
...
CREATE INDEX `fk_Venda_Produto1_idx` ON `soma`.`Servico` (`Produto_idProduto` ASC) VISIBLE;

CREATE INDEX `fk_Venda_Cliente1_idx` ON `soma`.`Servico` (`Cliente_idCliente` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`VendaVendedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`VendaVendedor` ;
...
CREATE INDEX `fk_Venda_has_Vendedor_Vendedor1_idx` ON `soma`.`VendaVendedor` (`Vendedor_idVendedor` ASC) VISIBLE;

CREATE INDEX `fk_Venda_has_Vendedor_Venda1_idx` ON `soma`.`VendaVendedor` (`Venda_idVenda` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Cobranca`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Cobranca` ;

CREATE TABLE IF NOT EXISTS `soma`.`Cobranca` (
  `idCobranca` INT NOT NULL AUTO_INCREMENT,
  `dataGerado` DATE NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE INDEX `fk_Cobranca_Cliente1_idx` ON `soma`.`Cobranca` (`Cliente_idCliente` ASC) VISIBLE;

CREATE INDEX `fk_Cobranca_Servico1_idx` ON `soma`.`Cobranca` (`Servico_idServico` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Comissao`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Comissao` ;
...
CREATE INDEX `fk_Comissao_Vendedor1_idx` ON `soma`.`Comissao` (`Vendedor_idVendedor` ASC) VISIBLE;

CREATE INDEX `fk_Comissao_Servico1_idx` ON `soma`.`Comissao` (`Servico_idServico` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `soma`.`Boleto`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `soma`.`Boleto` ;
...
CREATE INDEX `fk_Boleto_Cobranca1_idx` ON `soma`.`Boleto` (`Cobranca_idCobranca` ASC) VISIBLE;
