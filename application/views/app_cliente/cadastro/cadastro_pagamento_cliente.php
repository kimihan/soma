...
<div class="jumbotron d-flex align-items-center">
    <div class="container">
        ...
        <form action="<?= base_url() ?>app_cliente/pagamento" method="POST" id="fmrCadastroClientePagamento">
            ...
            <div class="form-row justify-content-center align-self-center" name="divPeriodo">
                <div class="col-12 mb-2">
                    <select class="form-control" name="periodo">
                        <option value="-1">Periodicidade de pagamento</option>
                        <?php
                        foreach ($periodicidade as $key => $value) {
            ...
            <div class="form-row justify-content-center align-self-center">
                ...
                <div class="col-6">
                    <button class="btn btn-outline-secondary btn-block" type="submit">Finalizar</button>
                </div>
            </div>
        </form>  
    </div>
...
<div class="modal fade" id="modalPagamentoSucesso" tabindex="-1" role="dialog" aria-labelledby="modalPagamentoSucesso" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="col-12 modal-title text-center">Adesão efetuada com sucesso!</h5>
            </div>
            <div class="modal-body">
                <p class="text-center">
                    <a href="<?= base_url() ?>app_cliente/login/logout" class="btn btn-outline-secondary btn-block" >Sair</a>
                </p>
            </div>
        </div>
    </div>
