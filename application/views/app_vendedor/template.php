            ...
            <nav class="navbar navbar-dark bg-dark">
                <?php 
                    if((count($this->session->userdata("sVendedor")) > 0)) {
                        echo '
                                <a class="navbar-brand" href="' . base_url() .'app_vendedor/login">' . NOME_APP_VENDEDOR . '</a>"
                        ...
                        echo "<a class='navbar-brand col-12 text-center' href='". base_url() ."app_vendedor/login'>" . NOME_APP_VENDEDOR . "</a>";
                    }
                ?>
            </nav>
        </div>
