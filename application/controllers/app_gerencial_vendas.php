...
class App_gerencial_vendas extends MY_Controller {
    ...
    {
        $dadosBusca = $_GET;
        $param["deleteMethod"] = "app_gerencial_vendas/ajax_excluir";
        $param["searchMethod"] = "app_gerencial_vendas/index";
        $param["referenceModel"] = "app_gerencial_vendas";
